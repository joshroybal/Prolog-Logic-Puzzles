% [food1, favorite1, hate1, food2, favorite2, hate2]
...
print_table(Table) :-
    ...
    format('~`=t~80|~n'),
    forall(member([Meal, Food, Fav, Hate], Table),
           format('~w~t~20|~w~t~40|~w~t~60|~w~n', [Meal, Food, Fav, Hate])),
    format('~`=t~80|~n').
